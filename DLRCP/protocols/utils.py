...
class Window(object):
    ...
    def getTimeoutPkts(self, updateTxAttempt: bool, curTime: int, RTO: int = -1, pktLossEst=None) -> list:
        """
        ...
        inputs:
            updateTxAttempt: whether to let pkt.txAttempt + 1
